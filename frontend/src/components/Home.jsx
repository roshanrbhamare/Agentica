...
//               <a href="#" className="-m-1.5 p-1.5">
//                 <span className="sr-only">NeuralLens</span>
//                 <img
//                   alt=""
//                   src="https://tailwindui.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600"
//                   className="h-8 w-auto"
...
//               Let's dive in the world of Ai search.{' '}
...
//               Enhance Your AI Response With IntelliDoc
//             </h1>
//             <p className="mt-8 text-pretty text-md font-medium text-gray-500 sm:text-xl/8">
//             AI-powered Document Analysis System automates the extraction, analysis, and retrieval of information from uploaded documents. Users can upload PDF files, which are converted into searchable text and stored in a vector database for efficient querying. Powered by advanced natural language processing (NLP)
//             </p>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-50 bg-white p-6">
            ...
            <div className="mt-6">
              ...
              <a
                href="/auth-page"
                className="block mt-4 px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50"
              >
                Log in
              </a>
            </div>
      ...
      <main className="relative px-6 pt-14 lg:px-8">
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24 text-center">
          ...
          <p className="mt-8 text-md font-medium text-gray-500 sm:text-md">
            ...
            analysis, and retrieval of information from uploaded documents.
            Users can upload PDF files, which are converted into searchable text
            and stored in a vector database for efficient querying.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="/upload"
